...
<div class="py-12">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
      <h2 style = >Manage <b>Events</b></h2>
     </div>
     <div class="col-sm-6">
        
      <a href="#addEmployeeModal" class="btn  btn-primary btn-sm" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Events</span></a>
      </div>
                </div>
            </div>
    ...
    <td class = "start_date">{{ Carbon\Carbon::parse($event -> start_date)->format('Y-m-d') }}</td>
...
<form action="{{ route('notice.destroy', $event->id) }}" method="post">
    ...
    <!-- <td class="d-flex justify-content-center">
    <a href="#" data-target="#editEmployeeModal" class="edit" data-toggle="modal">
        <i class="material-icons" data-toggle="tooltip" data-idUpdate = "'$event->id'" 
        title="Edit">&#xE254;</i></a> -->
                           
  <!-- <button type = "button" value = "{{ $event -> id }}" class="editbtn"><i class="material-icons editbtn" data-toggle="tooltip" title="Edit">&#xE254;</i></button> -->
  <!-- <form action="{{ route('notice.destroy', $event->id) }}" method="post">
                                        @csrf
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button type="submit" class="btn btn-danger delete px-1 py-0">
...
$('#title').val(_this.find('.id').text());
$('#description').val(_this.find('.id').text());
